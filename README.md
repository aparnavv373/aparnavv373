...
🎓 ECE Graduate | Frontend Developer  
💻 Passionate about building clean, responsive, and accessible websites  
🎯 Seeking Frontend Developer role to grow and contribute to innovative projects
...
## 🌱 Currently Learning
- **Advanced JavaScript (ES6+)** - Mastering modern JavaScript features
- **React.js Fundamentals** - Building component-based applications
- **Responsive Design Patterns** - Creating adaptive layouts
- **Git Workflows** - Collaborative development practices

## 🎯 Career Objective
Aspiring Frontend Developer with a solid foundation in web technologies, seeking an entry-level position to contribute to meaningful projects. Committed to writing clean, maintainable code and creating exceptional user experiences through pixel-perfect, accessible web applications.
